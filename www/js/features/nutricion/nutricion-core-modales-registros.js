...
function _nutriAbrirEdit(id){
    ...
    if(panel){ panel.style.height=window.innerHeight+'px'; panel.style.maxHeight=window.innerHeight+'px'; panel.style.transition='none'; panel.style.transform='translateY(100%)'; }
                ...
                <div class="card-bottom">
                    ...
                    <div class="card-actions">
                        <button class="card-btn-explorar card-btn-icon nutri-btn-editar"
                            style="flex:1;padding:8px 0;border-radius:10px;font-size:10px;font-weight:800;letter-spacing:0.12em;text-transform:uppercase;text-align:center;display:flex;align-items:center;justify-content:center;gap:4px;"
